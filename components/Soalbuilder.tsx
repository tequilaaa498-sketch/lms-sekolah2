      ...
      {tipe !== "ESSAY" && (
        <div>
            ...
            {opsiList.map((opsi, i) => (
              <div key={i} className="flex items-center gap-2">
                ...
                <input
                  ...
                  className="flex-1 rounded-lg border border-[#D1D5DB] px-3 py-2 text-sm outline-none focus:border-gray-900"
                />
                {opsiList.length > 2 && (
                  <button
                    type="button"
                    onClick={() => handleRemoveOpsi(i)}
                    className="cursor-pointer text-[#9CA3AF] hover:text-gray-900"
                  >
          ...
          <button
            ...
            className="mt-2 cursor-pointer text-xs font-semibold text-gray-900 hover:underline"
          >
            + Tambah Opsi
          </button>
        </div>
