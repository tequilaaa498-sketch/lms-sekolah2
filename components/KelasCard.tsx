...
export default function KelasCard({
  ...
  return (
    <article
      ...
      className="group relative cursor-pointer overflow-hidden border border-gray-300 bg-white transition-colors hover:border-gray-500"
    >
      <div className="flex items-center justify-between px-4 pt-4">
        ...
        {isEditable && (
          <div className="relative" onClick={(e) => e.stopPropagation()}>
            ...
            {menuOpen && (
              <div className="absolute right-0 top-8 z-20 w-32 overflow-hidden rounded-lg border border-black/5 bg-white shadow-lg">
                <button
                  onClick={() => {
                    setMenuOpen(false);
                    onEdit?.(data);
      ...
      {isEditable && (
        <div className="flex items-center gap-1 border-t border-black/5 px-4 py-2.5">
          <button
            ...
            className="flex cursor-pointer items-center gap-1 text-[11px] font-medium text-[#6B7280] hover:text-gray-900"
          >
