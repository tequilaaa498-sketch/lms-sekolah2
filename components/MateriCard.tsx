...
export default function MateriCard({ data, isEditable = false, onEdit, onDelete }: MateriCardProps) {
  ...
  return (
    <article className="flex items-start gap-3 border border-gray-300 bg-white p-4 transition-colors hover:border-gray-500">
      <div
      ...
      <div className="min-w-0 flex-1">
        <a
          ...
          className="block truncate text-sm font-bold text-[#111827] hover:text-gray-900"
        >
          {data.judul}
        </a>
