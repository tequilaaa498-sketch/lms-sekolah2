...
// POST /api/lupa-password/[id]/selesai -> admin tandai selesai, hapus laporan (apapun status OTP-nya)
export async function POST(req: NextRequest, { params }: Params) {
  try {
    ...
    return NextResponse.json({ message: "Laporan ditandai selesai dan dihapus." });
  } catch (err: any) {
