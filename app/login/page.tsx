              ...
              {info ? (
                ...
                <form onSubmit={handleLaporSubmit} className="mt-4 space-y-3">
                  ...
                  <textarea
                    ...
                    rows={3}
                    className="w-full resize-none rounded-lg border border-[#D1D5DB] px-4 py-2.5 text-sm outline-none focus:border-gray-900"
                  />
                ...
                <div className="flex justify-center gap-3">
                  {otpDigits.map((digit, i) => (
                    <input
                      ...
                      className="h-12 w-12 rounded-lg border border-[#D1D5DB] text-center text-lg font-bold outline-none focus:border-gray-900"
                    />
                  ))}
                </div>

                {error && <p className="text-center text-xs font-medium text-gray-700">{error}</p>}
